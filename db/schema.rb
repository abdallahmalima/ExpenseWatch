...
ActiveRecord::Schema[7.0].define(version: 2023_04_23_150857) do
  ...
  create_table "group_dealings", force: :cascade do |t|
    t.integer "group_id"
  ...
  add_foreign_key "group_dealings", "dealings", on_delete: :cascade
  add_foreign_key "group_dealings", "groups", on_delete: :cascade
